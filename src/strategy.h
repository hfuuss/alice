...
public:
    ...
    static const std::string D_L_CONF;
    static const std::string D_R_CONF;
    static const std::string Y_L_CONF;
    static const std::string Y_R_CONF;
...
private:
    ...
    rcsc::Formation::Ptr M_D_L_formation;
    rcsc::Formation::Ptr M_D_R_formation;



    rcsc::Formation::Ptr M_Y_L_formation;
    rcsc::Formation::Ptr M_Y_R_formation;
...
public:
    ...
    static
    double get_defender_dash_power( const rcsc::WorldModel & wm,const rcsc::Vector2D &  homePos);
};
