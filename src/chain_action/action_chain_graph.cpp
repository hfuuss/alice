...
const size_t ActionChainGraph::DEFAULT_MAX_CHAIN_LENGTH = 2;
const size_t ActionChainGraph::DEFAULT_MAX_EVALUATE_LIMIT = 2000;//test
 ...
 */
ActionChainGraph::ActionChainGraph( const FieldEvaluator::Ptr & evaluator,
...
//    calculateResultChain(wm,&n_evaluated);//test
