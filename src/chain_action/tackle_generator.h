...
#ifndef GENERATOR_TACKLE_H
#define GENERATOR_TACKLE_H
...
public:
   ...
   TackleGenerator & instance();
    ...
    const Result & bestResult( const rcsc::WorldModel & wm )
      {
          generate( wm );
...
private:
    ...
    double getOneStepMinimumOpponentDistance2( const rcsc::WorldModel & wm,
