...
private:
    ...
    int M_our_defense_line_count;// defense our count 
...
public:
    ...
    */
    ...
    /*!
     \brief get accuracy count for  our defense linex 
     \return  accuracy count 
     */
    
    int our_defense_line_count() const { return M_our_defense_line_count; }
...
private:
    ...
    const  AbstractPlayerObject *getPlayerNearestTo( const Vector2D & point,
                                                     const AbstractPlayerCont & players,
                                                     const int count_thr,
                                                     double * dist_to_point ) const;
...
public:
    ...
    */
    ...
    /*!
     * \brief get Teammate Include Self NearestTo point    dy  add  2016 0819
     * \param point
     * \param count_thr
     * \param dist_to_point
     * \return  if  found
...
//    const AbstractPlayerObject * getTeammateIncludeSelfNearestTo( const Vector2D & point,
//                                               const int count_thr,
//                                               double * dist_to_point ) const
//      {
//          return getPlayerNearestTo( point,ourPlayers(), count_thr, dist_to_point );
//      }
