...
const double ServerParam::DEFAULT_BALL_SPEED_MAX = 3.0;//// [12.0.0] 2.7 -> 3.0;
...
const double  ServerParam::DEFAULT_RED_CARD_PROBABLY=0.0;
...
ServerParam::setDefaultParam()
{
   ...
   // M_golden_goal = true;
    ...
    M_red_card_probably=DEFAULT_RED_CARD_PROBABLY; //dy  2016年 08月 23日 星期二 15:20:18 CST
...
ServerParam::createMap()
{
    M_param_map->add()
        ...
        //15.0.0  dy
        ("red_card_probability","", &M_red_card_probably)
